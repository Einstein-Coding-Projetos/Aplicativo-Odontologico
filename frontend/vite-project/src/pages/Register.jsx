...
export default function Register() {
  ...
  // ===== Pupila seguindo o mouse (igual login) =====
  useEffect(() => {
  ...
  // ===== Piscar os dois olhos juntos (igual login) =====
  useEffect(() => {
    let timerId;

    const schedule = () => {
      const ms = 2500 + Math.random() * 2200;
      timerId = setTimeout(() => {
        setIsBlinking(true);
    ...
    <div className="login-page">
      ...
      <div className="wrap">
        <header className="headline">
          <h1>Bem-vindo(a) ao OdontoGame,</h1>
          <p>Vamos começar nossa jornada pelo Reino dos Dentes.</p>
        </header>

        <section
          ref={toothRef}
          className="monster tooth"
          aria-label="Área de cadastro"
        >
          {/* bochechas */}
          ...
          <div className="belly">
            ...
            <button className="go" onClick={handleRegister} aria-label="Cadastrar">
              cadastrar
            </button>
